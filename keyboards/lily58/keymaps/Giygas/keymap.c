 ...
 */
 ...
 [_COLEMAK] = LAYOUT(
  ...
  KC_LCTRL, KC_A,   KC_R,    KC_S,    KC_T,    KC_D,                       KC_H,     LT(0, KC_N),    KC_E,      KC_I,    KC_O, KC_QUOT,
...
[_LOWER] = LAYOUT(
  ...
  KC_LSFT,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                                     KC_EQUAL, KC_HOME,   KC_UP,  KC_END,  XXXXXXX,KC_BRIGHTNESS_DOWN,
   ...
   KC_F12,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10, KC_AUDIO_VOL_UP, KC_AUDIO_VOL_DOWN,  KC_NUBS, KC_PMNS, KC_CAPS, XXXXXXX,  XXXXXXX,           XXXXXXX,
 ...
 * `-----------------------------------------/       /     \      \------------------------------------------'
 *                   |  COPY | PASTE | CUT| /Space  /       \Enter \  |      | TG(2) |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
  [_ADJUST] = LAYOUT(
